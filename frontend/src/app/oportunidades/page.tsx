...
export default function OportunidadesPage() {
  ...
  return <main className="flex min-h-screen bg-[#020817] text-white"><Sidebar /><section className="min-w-0 flex-1"><Topbar /><div className="space-y-6 p-4 sm:p-6 lg:p-8">
    <header className="flex flex-col gap-4 lg:flex-row lg:items-end lg:justify-between"><div><h1 className="text-3xl font-bold sm:text-4xl">CRM • Oportunidades</h1><p className="mt-2 text-gray-400">Uma linha por oportunidade. As descrições completas permanecem na tela de detalhes.</p></div><div className="flex flex-col gap-3 sm:flex-row"><Link href={relatorioHref} className="rounded-xl border border-cyan-700 px-5 py-3 text-center font-semibold text-cyan-300">Gerar relatório</Link><Link href="/crm-app/oportunidades/nova" className="rounded-xl bg-cyan-500 px-5 py-3 text-center font-semibold text-slate-950">Nova oportunidade</Link></div></header>
