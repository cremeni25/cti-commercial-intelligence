...
export default function NovoClientePage() {
  const [salvando, setSalvando] = useState(false), [erro, setErro] = useState(""), [sucesso, setSucesso] = useState("")
