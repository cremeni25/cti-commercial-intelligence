...
export default function Page() {
  return (
    <ModulePlaceholder
      title="DD • DIRECT DRIVE"
      description="
      Monitoramento estratégico da linha Direct Drive (DD), performance regional,
      crescimento operacional e oportunidades comerciais da operação CTI.
      "
    />
  )
}