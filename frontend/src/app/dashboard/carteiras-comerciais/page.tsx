...
export default function CarteirasComerciaisPage(){
 ...
 useEffect(()=>{if(!master)return;let ativo=true;void getResponsaveisComerciaisSeguros().then(r=>{if(ativo)setResponsaveis(r)}).catch(()=>{});void carregar("");return()=>{ativo=false}},[master])
