...
const fluxo = [
  ...
  ["05", "Executar", "A operação e a leitura executiva permanecem conectadas em uma mesma lógica comercial."],
]
...
export default function HomePage() {
  return (
    <main className="min-h-screen bg-[#020817] text-white selection:bg-cyan-400/30">
      ...
      <header className="sticky top-0 z-50 border-b border-white/8 bg-[#020817]/85 backdrop-blur-xl">
        <div className="mx-auto flex max-w-7xl items-center justify-between px-5 py-4 lg:px-8">
          ...
          <nav className="hidden items-center gap-7 text-sm text-slate-400 md:flex">
            ...
            <a href="#capacidades" className="transition hover:text-white">Capacidades</a>
          </nav>
        </div>
      </header>
        ...
        <div>
          ...
          <div className="mt-9 flex flex-wrap gap-3">
            <a href="#filosofia" className="inline-flex items-center gap-2 rounded-2xl border border-white/12 bg-white/[.03] px-5 py-3.5 font-semibold text-white transition hover:border-white/25 hover:bg-white/[.06]">
              Conhecer a filosofia <ArrowRight size={18} />
            </a>
          </div>
      ...
      <section id="capacidades" className="border-y border-white/8 bg-[#050d1b]">
        <div className="mx-auto max-w-7xl px-5 py-24 lg:px-8">
      ...
      <section className="mx-auto max-w-7xl px-5 py-24 lg:px-8">
        <div className="relative overflow-hidden rounded-[2.2rem] border border-cyan-400/15 bg-gradient-to-br from-cyan-400/10 via-[#071327] to-emerald-400/6 p-8 sm:p-12">
          <div className="absolute right-[-8rem] top-[-8rem] h-72 w-72 rounded-full bg-cyan-300/10 blur-3xl" />
          <div className="relative max-w-4xl">
            <p className="text-sm font-bold uppercase tracking-[.2em] text-cyan-300">CTI Comercial Intelligence</p>
            <h2 className="mt-4 text-4xl font-black tracking-[-.03em] sm:text-5xl">Menos ruído. Mais contexto. Decisões comerciais melhores.</h2>
            <p className="mt-5 max-w-3xl text-lg leading-8 text-slate-300">Uma arquitetura concebida para transformar informação dispersa em uma leitura comercial integrada, rastreável e orientada à decisão.</p>
          </div>
        </div>
      </section>
            ...
            <div className="grid gap-3 sm:grid-cols-2 lg:min-w-[31rem]">
              <Link href="https://app.cti-intelligence.com/dashboard" className="group flex items-center justify-between rounded-2xl border border-white/8 bg-[#071327]/55 px-4 py-3.5 transition hover:border-cyan-400/20 hover:bg-[#071327]">
                <span className="flex items-center gap-3">
                  <span className="rounded-xl bg-cyan-400/8 p-2 text-cyan-300"><Layers3 size={18} /></span>
                  <span>
                    <span className="block text-sm font-semibold text-white">CTI Web</span>
                    <span className="block text-xs text-slate-500">Ambiente executivo</span>
                  </span>
                </span>
                <ArrowRight size={16} className="text-slate-600 transition group-hover:text-cyan-300" />
              </Link>
              ...
              <Link href="https://app.cti-intelligence.com/crm-app" className="group flex items-center justify-between rounded-2xl border border-white/8 bg-[#071327]/55 px-4 py-3.5 transition hover:border-emerald-400/20 hover:bg-[#071327]">
                <span className="flex items-center gap-3">
                  <span className="rounded-xl bg-emerald-400/8 p-2 text-emerald-300"><UsersRound size={18} /></span>
                  <span>
                    <span className="block text-sm font-semibold text-white">CRM App</span>
                    <span className="block text-xs text-slate-500">Ambiente operacional</span>
                  </span>
                </span>
                <ArrowRight size={16} className="text-slate-600 transition group-hover:text-emerald-300" />
              </Link>
            </div>
          </div>
        </div>
