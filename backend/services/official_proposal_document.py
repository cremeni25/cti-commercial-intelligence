...
FIELD_ANCHORS: dict[str, tuple[str, ...]] = {
    ...
    "email": ("E-mail:",),
    "quantidade_texto": ("Segue para apreciação nossa proposta venda de",),
    "voltagem": ("Voltagem:",),
    ...
    "frete": ("Frete:",),
    "prazo_entrega": ("Prazo de entrega:", "Prazo Entrega:"),
...
PAYLOAD_FIELD_MAP: dict[str, str] = {
    ...
    "client_email": "email",
    "quantity_intro": "quantidade_texto",
    "voltage": "voltagem",
    ...
    "has_down_payment": "possui_entrada",
