...
insert into public.cti_user_permissions (user_id, acesso_portal, acesso_crm, dashboard_executivo, clientes_visualizar, clientes_editar, oportunidades_visualizar, oportunidades_editar, propostas_visualizar, propostas_emitir, pedidos_visualizar, pedidos_converter, pedidos_enviar, financeiro_visualizar, usuarios_administrar, configuracoes_administrar, acesso_total)
select id, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true
from public.cti_users where upper(coalesce(tipo_usuario, '')) = 'ADMIN_MASTER'
on conflict (user_id) do update set acesso_portal=true, acesso_crm=true, dashboard_executivo=true, clientes_visualizar=true, clientes_editar=true, oportunidades_visualizar=true, oportunidades_editar=true, propostas_visualizar=true, propostas_emitir=true, pedidos_visualizar=true, pedidos_converter=true, pedidos_enviar=true, financeiro_visualizar=true, usuarios_administrar=true, configuracoes_administrar=true, acesso_total=true, updated_at=now();
