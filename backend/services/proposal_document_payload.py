...
def build_proposal_document_payload(
    *,
    ...
    fields: dict[str, Any] = {
        ...
        "voltage": _first(item, "voltagem", "tensao"),
        "quantity": quantity,
        ...
        "has_down_payment": _first(item, "possui_entrada", "entrada_sim_nao"),
        "down_payment_value": _first(item, "valor_entrada"),
        "delivery_type": _first(item, "tipo_entrega", "local_entrega"),
        "authorized_service_name_address": _first(item, "autorizada_nome_endereco", "autorizada"),
        ...
        "lynx_months": _first(item, "lynx_meses", "periodo_lynx_meses"),
