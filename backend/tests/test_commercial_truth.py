from services.commercial_truth import _desfecho, _ordem_temporal_valida


def test_cadeia_crm_funil_anfir_carrier_confirma_sucesso():
    eventos = [
        {"fonte": "CRM", "data_evento": "2026-01-10", "estado_comercial": "CONCLUIDA"},
        {"fonte": "FUNIL", "data_evento": "2026-02-15", "estado_comercial": "BACKLOG"},
...
def test_mencao_concorrente_anfir_nao_vira_sucesso():
    eventos = [
        {"fonte": "CRM", "data_evento": "2026-01-10", "estado_comercial": "CONCLUIDA"},
        {"fonte": "FUNIL", "data_evento": "2026-02-15", "estado_comercial": "PERDIDO"},
...
def test_funil_aberto_permanece_backlog_sem_anfir():
    eventos = [
        ...
        {"fonte": "FUNIL", "data_evento": "2026-06-01", "estado_comercial": "ABERTA"},
    ]
...
def test_ordem_temporal_invertida_nao_e_confirmada():
    eventos = [
        ...
        {"fonte": "FUNIL", "data_evento": "2026-02-01", "estado_comercial": "GANHO"},
