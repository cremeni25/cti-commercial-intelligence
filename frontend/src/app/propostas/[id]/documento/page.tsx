...
export default function DocumentoPropostaPage() {
  ...
  useEffect(() => {
    ...
    void (async () => {
      try {
        ...
        if (!finalizar.ok) throw new Error(finalizado?.detail || "Não foi possível finalizar o documento oficial.")
  ...
  return <main className="min-h-screen bg-slate-100 px-4 py-8">
    <div className="mx-auto max-w-3xl">
      ...
      {carregando && <div className="rounded-xl bg-white p-8 text-slate-600 shadow-sm">Finalizando e validando o documento oficial Carrier...</div>}
