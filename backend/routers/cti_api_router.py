...
from routers.crm_app_proposta_pdf_validacao_router import router as crm_app_proposta_pdf_validacao_router
...
router.include_router(crm_app_proposta_pdf_validacao_router)
...
router.include_router(backoffice_fontes_promocao_router)
