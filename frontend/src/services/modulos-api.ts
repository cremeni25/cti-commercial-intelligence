...
export type EmpresaResumoItem = { nome: string; quantidade_registros: number; valor_total?: number; estados?: string[]; municipios?: string[]; linhas?: string[]; status?: Record<string, number> }
