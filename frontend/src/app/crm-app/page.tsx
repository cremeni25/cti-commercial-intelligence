...
const atalhos = [
  {
    ...
    descricao: "Registrar visita, ligação, reunião, retorno ou próxima ação",
    icon: ClipboardCheck,
  },
  {
          ...
          <div className="space-y-5">
            ...
            <section>
              <div className="mb-4 flex items-center justify-between">
                <h2 className="text-xl font-semibold">Interações rápidas</h2>
              ...
              <div className="grid gap-4 sm:grid-cols-2">
                {atalhos.map(({ href, titulo, descricao, icon: Icon }) => (
                  <Link
                    key={href}
                    href={href}
                    className="flex min-h-24 items-center gap-4 rounded-2xl border border-[#16325c] bg-[#091a33] p-5"
                  >
                    <span className="rounded-2xl bg-cyan-950/50 p-4 text-cyan-300">
                      <Icon size={22} />
                    </span>
            ...
            <div className="grid grid-cols-2 gap-4 xl:grid-cols-3">
              {modulos.map(({ href, label, valor, descricao, icon: Icon }) => (
                <Link
                  href={href}
                  key={label}
                  className="flex min-h-36 flex-col justify-between rounded-2xl border border-[#16325c] bg-[#07162b] p-5 transition hover:border-cyan-700"
                >
