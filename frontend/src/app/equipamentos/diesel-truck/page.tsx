...
export default function Page() {
  return (
    <ModulePlaceholder
      title="DT • DIESEL TRUCK"
      description="
      Inteligência operacional da linha Diesel Truck (DT), análise comercial,
      expansão territorial e monitoramento estratégico do mercado refrigerado.
      "
    />
  )
}